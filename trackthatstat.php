...
function load_trackthatstat_admin_scripts() {
	...
	wp_register_style( 'track-jqplot-css', plugins_url('js/jqplot/jquery.jqplot.min.css', __FILE__) );
	wp_enqueue_style( 'track-jqplot-css' );

    wp_enqueue_script( 'track-jqplot-js' , WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/jqplot/jquery.jqplot.min.js');
    wp_enqueue_script( 'track-jqplot-highlighter-js',WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/jqplot/jqplot.highlighter.min.js' );
    wp_enqueue_script( 'track-jqplot-cursor-js',WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/jqplot/jqplot.cursor.min.js' );

    wp_enqueue_script( 'track-jqplot-date-js',WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/jqplot/jqplot.dateAxisRenderer.min.js' );
    wp_enqueue_script( 'track-jqplot-text-js',WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/jqplot/jqplot.canvasTextRenderer.min.js' );
    wp_enqueue_script( 'track-jqplot-tick-js',WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/jqplot/jqplot.canvasAxisTickRenderer.min.js' );
