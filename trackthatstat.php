...
<div style="width:1000px;height:160px;">
		<h3 align="center"><a href="http://trackthatstat.org" target="_blank">TTS Blog</a>  | FAQ | <a href="http://trackthatstat.org/contact-us/" target="_blank">Support</a> | <a href="http://trackthatstat.org/donate/" target="_blank">Donate</a> </h3>
			  ...
			  <p><span class="style1">Thank you for using our new plugin. If you have any questions please feel free to use the support button above. Also, check out <a href="http://trackthatstat.org/go/my-pc-back-up/" target="_blank"><strong>My PC Backup</strong></a>. This is a great new service that is trused by the <u>Better Business Bureau</u>. You can sign up for a<strong> FREE ACCOUNT</strong> today to give it a test drive. </span></p>
			  <a href="http://trackthatstat.org/go/my-pc-back-up/" target="_blank"><img src="http://trackthatstat.org/wp-content/uploads/2012/04/mypcbackup.jpg" width="728" height="90" border="0" /></a><a target="_blank" href="http://trackthatstat.org/go/my-pc-back-up/"></a></div>
			</div>
