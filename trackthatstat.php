...
<div style="width:1000px;height:160px;">
		<h3 align="center"><a href="http://trackthatstat.org" target="_blank">TTS Blog</a>  | FAQ | <a href="http://trackthatstat.org/contact-us/" target="_blank">Support</a> | <a href="http://trackthatstat.org/donate/" target="_blank">Donate</a> </h3>
			  ...
			  <p class="style1">Thank you for using our new plugin. If you have any questions please feel free to use the support button above. Also, if you are doing any<strong> SEO</strong> you know that one of the key things are <u>BackLinks</u>. You need BackLinks In order to rank in the <b>Search Engines</b>. Check out  <a href="http://trackthatstat.org/go/abc-3k/" target="_blank"><strong>ABC3k</strong></a> and <a href="http://trackthatstat.org/go/backlink-indexer/" target="_blank"><strong>Backlink Indexer</strong></a> to improve on your SEO. </p>
			  <a href="http://trackthatstat.org/go/abc-3k/" target="_blank"><img src="http://blog.abc3k.com/banners/spraypaint/728x90.png" width="728" height="90" border="0" /></a><a target="_blank" href="http://trackthatstat.org/go/my-pc-back-up/"></a></div>
			</div>
...
<?php
		...
		function _assert_db_structure() {
			...
			$wpdb->query("CREATE TABLE IF NOT EXISTS ".$wpdb->prefix."tts_online_status(`id` bigint(20) NOT NULL AUTO_INCREMENT, `ip_address` varchar(20) NOT NULL DEFAULT '',`last_active_time` int(10) unsigned NOT NULL DEFAULT '0',PRIMARY KEY (`id`),KEY `ip_address` (`ip_address`)) ENGINE=MyISAM");
