...
<div style="width:1000px;height:130px;">
		<h3 align="center"><a href="http://trackthatstat.org" target="_blank">TTS Blog</a>  | FAQ | <a href="http://trackthatstat.org/contact-us/" target="_blank">Support</a> | <a href="http://trackthatstat.org/donate/" target="_blank">Donate</a> </h3>
...
function load_trackthatstat_scripts() {
   ...
   // wp_register_script( 'highcharts', WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/highcharts.js');
    ...
    wp_register_script( 'trackthatstat', WP_PLUGIN_URL.'/'.TRACK_PLUGIN_NAME.'/js/trackthatstat.php?data='.base64_encode($data));
    wp_enqueue_script( 'trackthatstat' );
